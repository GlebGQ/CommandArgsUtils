public class ArgsException extends Exception{
    ...
    public String errorMessage() throws Exception{
        return switch (errorCode) {
            ...
            case INVALID_FORMAT -> String.format("Argument -%c has invalid tail '%s'.", errorArgumentId, errorParameter);
            case INVALID_ARGUMENT_NAME -> String.format("Argument -%c is expected to be letter", errorArgumentId);
        };
    }
    
    public enum ErrorCode{
        OK, MISSING_STRING, MISSING_INTEGER, INVALID_INTEGER, UNEXPECTED_ARGUMENT,
        MISSING_DOUBLE, INVALID_DOUBLE, INVALID_FORMAT, INVALID_ARGUMENT_NAME
    }
}
